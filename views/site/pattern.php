...
<table width="100%" border="0" cellpadding="0" cellspacing="0" align="center">
    <tr>
        <td width="100%" valign="top" bgcolor="#ffffff" style="padding-top:20px">
            ...
            <!-- 3 Small Images -->
            <table width="580" cellpadding="0" cellspacing="0" align="center" class="deviceWidth" bgcolor="#fff" style="margin:0 auto;">
                                ...
                                <table width="32%" align="left" cellpadding="0" cellspacing="0" class="deviceWidth">
                                    <tr>
                                        <td valign="top" align="center" style="padding:10px 0">
                                            <p style="mso-table-lspace:0;mso-table-rspace:0; margin:0">
                                                ...
                                                <a href="#"><img width="170" src="<?= $img[0] ?>" alt="" border="0" style="border-radius: 4px; width: 170px;" class="deviceWidth" /></a>
                                    ...
                                    <tr>
                                        <td style="padding:0 10px 20px 10px">
                                            <a href="#"
                                               style="text-decoration: none; font-size: 14px; color: #111; font-weight: bold; font-family:Open Sans, Arial, sans-serif "> <?= $name['ID'] ?></a>

                                            <p style="color:#111; text-align:left; font-size: 13px; line-height:17px; font-family:Open Sans, Arial, sans-serif">
